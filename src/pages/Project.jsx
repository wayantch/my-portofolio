...
const categories = ["Semua", "Landing Page", "Proyek Klien"];
...
const Project = () => {
    ...
    return (
      <div className="relative">
        <h1 className="text-3xl font-semibold text-white">Proyek</h1>
        <p className="text-gray-300 mb-6">
          Ini dia beberapa proyek yang udah pernah saya garap. Yuk intip-intip~
          👀
        </p>
